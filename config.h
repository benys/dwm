...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask|ControlMask,             XK_h,      setcfact,       {.f = 0} },
	{ MODKEY|ShiftMask|ControlMask,             XK_l,      setcfact,       {.f = 0} },
	...
	{ MODKEY,			XK_z,		spawn,		{.v = (const char*[]){ "handy", "--toggle-transcription", NULL } } },
